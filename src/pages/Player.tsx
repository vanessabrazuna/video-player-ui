            ...
            <div>
              <button className="flex w-full items-center gap-3 bg-zinc-800 p-4">
                ...
                <div className="flex flex-col gap-1 text-left">
                  ...
                  <span className="text-xs text-zinc-400">4 aulas</span>
                </div>
              ...
              <nav className="relative flex flex-col gap-4 p-6">
                <button className="flex items-center gap-3 text-sm text-zinc-400">
                  ...
                  <span className="ml-auto font-mono text-xs text-zinc-500">16:33</span>
                </button>

                <button className="flex items-center gap-3 text-sm text-zinc-400">
                  <Video className="w-4 h-4 text-zinc-500" />
                  <span>Criando store do Redux</span>
                  <span className="ml-auto font-mono text-xs text-zinc-500">12:17</span>
                </button>

                <button className="flex items-center gap-3 text-sm text-zinc-400">
                  <Video className="w-4 h-4 text-zinc-500" />
                  <span>Disparando actions no Redux</span>
                  <span className="ml-auto font-mono text-xs text-zinc-500">09:24</span>
                </button>

                <button className="flex items-center gap-3 text-sm text-zinc-400">
                  <Video className="w-4 h-4 text-zinc-500" />
                  <span>Utilizando Redux DevTools</span>
                  <span className="ml-auto font-mono text-xs text-zinc-500">03:06</span>
                </button>
              </nav>
            </div>
          </aside>
